      ...
      @if (loading()) {
        ...
        <div class="stats stats-vertical lg:stats-horizontal shadow w-full mb-6">
          <div class="stat">
            ...
            <div class="stat-desc">
              {{ stats().draft.total | currency:'CHF':'code':'1.2-2' }}
            </div>
          </div>
          <div class="stat">
            <div class="stat-title">{{ t().dashboard.outstanding }}</div>
            <div class="stat-value text-2xl text-info">{{ stats().issued.count }}</div>
            <div class="stat-desc">
              {{ stats().issued.total | currency:'CHF':'code':'1.2-2' }}
            </div>
          </div>
          <div class="stat">
            ...
            <div class="stat-desc">
              {{ stats().paid.total | currency:'CHF':'code':'1.2-2' }}
            </div>
          </div>
          <div class="stat">
                ...
                <tbody>
                  @for (inv of stats().recentInvoices; track inv.id) {
                    <tr>
                      ...
                      <td class="text-right">{{ inv.total | currency:'CHF':'code':'1.2-2' }}</td>
                      <td>
